...
function InfoMenu({user}) {
  return (
    <div>
        <div className='w-32 h-32 mx-auto p-5  flex items-center justify-center relative  '>
           ...
           <AiFillCamera className='absolute bottom-5 cursor-pointer right-5 text-gray-500 text-3xl bg-white  p-[3px] rounded-full' />
        </div>
        <div className='w-full h-5   flex items-center justify-center'>
            <span className='text-gray-500 text-sm font-bold'>{user.firstName + ' ' + user.lastName}</span>
        </div>
        <div className='w-full h-5 mb-5  flex items-center justify-center'>
