    ...
    <>
        {
            ...
            <div className='w-full'>
                <div className="w-full px-10 flex flex-col md:flex-row md:space-x-5">
                    <div className='w-full md:w-1/3 bg-gray-50 rounded border border-gray-100'>
                        <SettingsMenu user={user} />
                    </div>
                    <div className="w-full md:w-3/4 bg-gray-50 rounded border border-gray-100 flex place-content-center place-items-center">
                        {
